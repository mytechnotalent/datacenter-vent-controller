...
def _draw_titles(banner, colors) -> None:
    ...
    None
    """
    banner.text("DATACENTER VENT CONTROLLER", 4,
                colors["gold"], banner.W // 2, 90)
    banner.text("OPERATION IRON VAULT", 9, (0x0B, 0x10, 0x26),
                banner.W // 2 - 6, 176)
    banner.text("OPERATION IRON VAULT", 9, colors["white"],
                banner.W // 2, 182)
...
def _draw_features(banner, colors) -> None:
    ...
    None
    """
    banner.text("VENT DAMPER  MANUAL PURGE", 5, colors["cyan"],
                banner.W // 2, 750)
    banner.text("IR REMOTE  DHT11 SENSOR", 4, colors["silver"],
                banner.W // 2, 900)
    banner.text("TOWER LIGHT  FAIL OPEN", 3, colors["silver"],
                banner.W // 2, 990)
    ...
    banner.text("AVAILABILITY  ANTI-DEBUG", 4, colors["gold"],
                banner.W // 2, 1350)
    banner.text("-=[ OPERATION IRON VAULT  /  RP2350 ]=-", 3, colors["dim"],
                banner.W // 2, 1440)
