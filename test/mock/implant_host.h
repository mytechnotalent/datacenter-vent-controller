 ...
 *
 * DESCRIPTION:
 * Host mock header for the FROSTLINE locker CoreDebug and reserved
 * flash accesses so the anti-debug, ransom lock, and persistence paths
 * are testable.
 *
 * BRIEF:
